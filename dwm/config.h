...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_p,           spawn,          {.v = (const char*[]){ "passrofi", NULL } } },
    ...
    { MODKEY|ShiftMask,             XK_m,           spawn,          SHCMD ("umounter")},
    { MODKEY,                       XK_w,           spawn,          SHCMD ("setbg -s ~/Pictures/Wallpapers")},
    { MODKEY,                       XK_g,           spawn,          SHCMD ("wine ~/.config/forsen/forsen.exe")},
    { MODKEY|ShiftMask,             XK_g,           spawn,          SHCMD ("wine ~/.config/forsen-2/forsen2.exe")},
